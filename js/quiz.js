...
(function () {
  ...
  var _QS = [
    ...
    'justify-content:center;padding:24px;background:#0b0219;visibility:visible!important;',
    "font-family:'IBM Plex Mono',ui-monospace,monospace}",
    '#lv-quiz .bx{position:relative;z-index:1;width:min(520px,92vw);border:1px solid rgba(0,225,255,0.55);',
    ...
    "font-family:'Nunito',sans-serif;text-wrap:pretty}",
    ...
    '#lv-quiz input:focus{border-color:#b026ff;box-shadow:0 0 0 1px rgba(176,38,255,0.35)}',
    '#lv-quiz input[disabled]{opacity:0.5;cursor:default}',
    '#lv-quiz .err{min-height:16px;font-size:10px;letter-spacing:0.1em;color:#ff2fbf;margin:9px 2px 0}',
    '#lv-quiz button{width:100%;margin-top:10px;cursor:pointer;background:#00e1ff;border:1px solid #00e1ff;',
    'color:#0b0219;font-family:inherit;font-weight:700;font-size:11px;letter-spacing:0.22em;padding:13px}',
    '#lv-quiz button:hover{background:#7ff4ff}',
  ...
  function trap(done) {
    ...
    fetch('./transcript.html', { cache: 'no-store' }).then(function (r) {
      ...
      decoy.innerHTML = '<div style="padding:40px;font:14px/1.7 IBM Plex Mono,monospace;color:#f0e2ff">TRANSCRIPT INDEX ERROR — ' + String(e.message).replace(/[&<>]/g, '') + '</div>';
      setTimeout(function () { location.href = './transcript2.html'; }, TRAP_MS);
    });
  }
