...
(function () {
  ...
  var CSS = [
    ...
    "#lv-sin h2{margin:14px 0 0;font-family:'Unbounded',sans-serif;font-weight:900;font-size:clamp(22px,5vw,38px);",
    'line-height:.98;color:#fff;letter-spacing:-.02em}',
    "#lv-sin .say{margin:16px 0 0;font-family:'Space Grotesk',sans-serif;font-size:14px;line-height:1.8;",
