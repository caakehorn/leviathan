...
// chromatic aberration, glitch, scanlines, Anton mastheads carried over
...
.rdr-wm{position:absolute;right:-2%;top:50%;transform:translateY(-50%);z-index:-1;pointer-events:none;
  font-family:'Anton',sans-serif;font-weight: 400;font-size:clamp(70px,15vw,210px);line-height:.8;
...
/* the title: Anton (same family as the splash) sitting WHITE and legible
...
.rdr-title{position:relative;margin:0;font-family:'Anton',sans-serif;font-weight: 400;
...
/* ── body ── */
.rdr-body{padding:44px 0 0;font-family:'Chakra Petch',sans-serif;position:relative}
...
.rdr-body h2{position:relative;margin:52px 0 20px;padding-left:18px;
  font-family:'Anton',sans-serif;font-weight: 400;font-size:clamp(19px,2.3vw,27px);
...
.rdr-ebody .c{font-family:'Chakra Petch',sans-serif;font-size:13.4px;line-height:1.7;color:#d9f2e0;font-style:italic}
...
.rdr-pv .t{padding:11px 12px 4px;font-family:'Anton',sans-serif;font-weight: 400;font-size:14px;color:#fff;line-height:1.25}
.rdr-pv .s{padding:0 12px 12px;font-family:'Chakra Petch',sans-serif;font-size:12px;line-height:1.62;color:#d9f2e0}
...
.rdr-404 div:first-child{font-family:'Anton',sans-serif;font-weight: 400;font-size:54px;color:#b026ff;
