...
(function () {
  ...
  var CSS = [
    ...
    "#lv-tos h1{font-family:'Zen Kaku Gothic New',sans-serif;font-size:16px;letter-spacing:0.14em;color:#7ff4ff;",
    ...
    "#lv-tos p{font-family:'Zen Kaku Gothic New',sans-serif;font-size:12.5px;line-height:1.75;color:#d6bcf5;",
